...
class MessageEnum(Enum):
    ...
    must_be_every_parame = 100182, '请准确填写各项信息'
    ...
    assert_error = 100231, '测试套件断言失败，请检查返回'
    ...
    task_create_error = 100240, '创建任务异常'
    task_query_error = 100241, '查询任务异常'
    invalid_datetime_format = 100242, '无效的日期格式'
    task_not_exist = 100243, '任务不存在'
    task_is_running = 100244, '任务正在运行'
    task_execute_error = 100245, '执行任务异常'
    task_not_finished = 100246, '任务未完成'
