...
_NOROOMRSP = _descriptor.Descriptor(
  name='NoRoomRSP',
  full_name='pb.NoRoomRSP',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
DESCRIPTOR.message_types_by_name['NoRoomRSP'] = _NOROOMRSP
...
NoRoomRSP = _reflection.GeneratedProtocolMessageType('NoRoomRSP', (_message.Message,), dict(
  DESCRIPTOR = _NOROOMRSP,
  __module__ = 'pb8_pb2'
  # @@protoc_insertion_point(class_scope:pb.NoRoomRSP)
  ))
_sym_db.RegisterMessage(NoRoomRSP)
