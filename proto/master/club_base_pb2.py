...
_CLUBMEMBERSORTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLUB_MEMBER_KYCLVL2_DES', index=17, number=17,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLUB_MEMBER_KYCLVL2_AES', index=18, number=18,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
CLUB_MEMBER_KYCLVL2_DES = 17
CLUB_MEMBER_KYCLVL2_AES = 18
