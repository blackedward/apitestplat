...
_ITEMRECORD_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='pb.ItemRecord.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='USED', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_ITEMRECORD_TYPE)
...
_ITEMRECORD.fields_by_name['type'].enum_type = _ITEMRECORD_TYPE
_ITEMRECORD_TYPE.containing_type = _ITEMRECORD
...
_GAMEDATAREQ.fields_by_name['btime']._options = None
_GAMEDATAREQ.fields_by_name['etime']._options = None
_GAMEDATAREQ.fields_by_name['leagueid']._options = None
_BLINDCOININFO.fields_by_name['blind_coin_class_id']._options = None
_BLINDCOININFO.fields_by_name['blind_coin_class_name']._options = None
_FETCHBLINDCOINREWARDREQ.fields_by_name['blind_coin_class_id']._options = None
